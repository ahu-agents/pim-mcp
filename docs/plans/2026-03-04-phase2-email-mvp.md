...
Run: `cd /path/to/pim-agents && npx vitest run packages/core/src/__tests__/emailConfig.test.ts`
...
Run: `cd /path/to/pim-agents && npx vitest run packages/core/`
...
Run: `cd /path/to/pim-agents && npm install`
Expected: All dependencies installed, no errors

**Step 8: Verify build and typecheck**

Run: `cd /path/to/pim-agents && npx turbo run build typecheck`
...
Run: `cd /path/to/pim-agents && npx vitest run packages/email-mcp/src/__tests__/search.test.ts`
...
Run: `cd /path/to/pim-agents && npx vitest run packages/email-mcp/src/__tests__/ImapService.test.ts`
...
Run: `cd /path/to/pim-agents && npx vitest run packages/email-mcp/src/__tests__/SmtpService.test.ts`
...
Run: `cd /path/to/pim-agents && npx vitest run packages/email-mcp/src/__tests__/emailTools.test.ts`
...
Run: `cd /path/to/pim-agents && npx vitest run packages/email-mcp/`
Expected: All tests pass

**Step 4: Run full test suite**

Run: `cd /path/to/pim-agents && npx vitest run`
...
Run: `cd /path/to/pim-agents && npx biome check --write .`
Expected: Formatting applied, no errors

**Step 2: Run typecheck**

Run: `cd /path/to/pim-agents && npx turbo run typecheck`
...
Run: `cd /path/to/pim-agents && git push origin main`
